...
export const socialLinks: SocialLink[] = [
  ...
  // {
  //   name: "CodeForces",
  //   href: "https://codeforces.com/profile/muhammadfarooq85",
  //   label: "CodeForces",
